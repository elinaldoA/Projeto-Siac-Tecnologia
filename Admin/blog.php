      ...
      <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">Blog</h2>
                 <p class="text-center wow fadeInDown">
                    Confira as ultimas novidades em nosso blog
                </p>
            </div>
        <!-- Post Content Column -->
        <div class="col-md-8">
    ...
    <section id="get-in-touch">
        <div class="container">
            <div class="section-header">
                ...
                <p class="text-center wow fadeInDown">A SIAC Tecnologia tem a solução ideal para o seu negócio.</p>
                ...
                <div class="row">
                    <div class="col-sm-4 col-sm-offset-8">
                        <div class="contact-form">
                            ...
                            <address>
                              <strong>SIAC Tecnologia Eireli - ME.</strong><br>
                              Shopping MontSerrat, Sala 329<br>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ul class="social-icons">
                        <!--<li><a href="#"><i class="fa fa-2x fa-facebook"></i></a><br></li>-->
                        <li><a href="https://www.instagram.com/siactecnologia/"><i class="fa fa-2x fa-instagram"></i></a><br></li>
                        <li><a href="https://twitter.com/SIAC_Tecnologia"><i class="fa fa-2x fa-twitter"></i></a><br></li>
                        <li><a href="https://www.linkedin.com/company/siac-tecnologia/"><i class="fa fa-2x fa-linkedin"></i></a><br>
                    </ul>
                </div>
            </div>
        </div>
